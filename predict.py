...
if __name__ == "__main__":
    ...
    parser.add_argument('--context-file', type=str, default='evaluation_data_loader/test_ctx.txt', help='Path to context file. Each line is a context.')
    parser.add_argument('--response-file', type=str,default='evaluation_data_loader/test_res.txt', help='Path to response file. Each line is a response.')
